import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-6cc2c792.js";const i={},t=e(`<h1 id="git常用命令汇总" tabindex="-1"><a class="header-anchor" href="#git常用命令汇总" aria-hidden="true">#</a> Git常用命令汇总</h1><h2 id="一、git安装后-指定名称和邮箱" tabindex="-1"><a class="header-anchor" href="#一、git安装后-指定名称和邮箱" aria-hidden="true">#</a> 一、Git安装后-指定名称和邮箱</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> config <span class="token parameter variable">--global</span> user.name <span class="token string">&quot;Your Name&quot;</span>
