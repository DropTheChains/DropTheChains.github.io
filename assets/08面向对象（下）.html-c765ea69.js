import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t}from"./app-f9dd4f6a.js";const p={},e=t(`<h1 id="_08面向对象-下" tabindex="-1"><a class="header-anchor" href="#_08面向对象-下" aria-hidden="true">#</a> 08面向对象(下)</h1><h1 id="_01、关键字-static" tabindex="-1"><a class="header-anchor" href="#_01、关键字-static" aria-hidden="true">#</a> 01、关键字：static</h1><h2 id="_1-1、static-的使用" tabindex="-1"><a class="header-anchor" href="#_1-1、static-的使用" aria-hidden="true">#</a> 1.1、static 的使用</h2><p>当我们编写一个类时，其实就是在描述其对象的属性和行为，而并没有产生实质上的对象，只有通过 new 关键字才会产生出对象，这时系统才会分配内存空间给对象，其方法才可以供外部调用。</p><p>我们有时候希望无论是否产生了对象或无论产生了多少对象的情况下，<strong>某些特定的数据在内存空间里只有一份。</strong></p><p>例如所有的中国人都有个国家名称，每一个中国人都共享这个国家名称，不必在每一个中国人的实例对象中都单独分配一个用于代表国家名称的变量。</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">/*
 * static 关键字的使用
 * 
 * 1.static:静态的。
